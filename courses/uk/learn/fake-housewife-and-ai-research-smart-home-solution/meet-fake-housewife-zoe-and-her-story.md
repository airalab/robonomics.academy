...
Привіт, Зоє! Я можу запропонувати кілька сценаріїв для перерв, які допоможуть вам віднвитися та розслабитися:
...
2. Сценарій йоги:
    ...
    - Почніть виконувати легкі вправи йоги, такі як Сонячне Віання, Поза Дерева та інші, які вам подобаються.
