      ...
      <section class="container__reg">
        ...
        <List type="numbers">
          <li>
            ...
            <p>b) Buy XRT ERC-20 on <g-link to="https://www.coingecko.com/en/coins/robonomics-network#markets">one of the available exchanges</g-link>. Be careful if you're not familiar with cryptocurrency exchanges, remember that all purchases on cryptocurrency exchanges may have potential risks, buy only required amount of token to pass this lesson. After getting ERC-20 XRT (XRT on Ethereum) you will need to transfer them to Robonomics Parachain using <g-link to="https://dapp.robonomics.network/#/exodus">Exodus process</g-link>. Do not forget to use your previously created polkadot.js account while submitting Exodus.</p>
