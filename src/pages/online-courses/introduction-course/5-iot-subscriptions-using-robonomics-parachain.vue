      ...
      <section class="container__reg">
        ...
        <List type="numbers">
          <li>
            ...
            <p>b) Buy native XRT token on Kusama using <g-link to="https://trade.kraken.com/markets/kraken/xrt/usd">the available exchange</g-link>. You can use the created Robonomics Parachain account for the exchange and withdraw XRT tokens directly to this account. Be careful if you're not familiar with cryptocurrency exchanges, remember that all purchases on cryptocurrency exchanges may have potential risks, buy only required amount of token to pass this lesson.</p>
            <p>c) Buy XRT ERC-20 (XRT on Ethereum) on <g-link to="https://www.coingecko.com/en/coins/robonomics-network#markets">one of the available exchanges</g-link>. After getting ERC-20 XRT you will need to transfer them to Robonomics Parachain using <g-link to="https://dapp.robonomics.network/#/exodus">Exodus process</g-link>. Do not forget to use your previously created polkadot.js account while submitting Exodus.</p>
          </li>
          <li>
