<template>
  <LayoutCourse courseId="1" lessonId="3">
    ...
    <MetaInfo
      ...
      pageDescription = "In this lesson you will try to control a smart light bulb using Robonomics parachain."
    ...
    <section class="text__hyphened">
      ...
      <section class="container__narrow">
        <h2>{{$ts("Intro")}}</h2>
        <p>{{$ts('In this lesson you will try to control a smart light bulb. Your goal is to turn the bulb on/off using the standard Polkadot/Substrate interface on the Robonomics parachain. The bulb is broadcasting on')}}
