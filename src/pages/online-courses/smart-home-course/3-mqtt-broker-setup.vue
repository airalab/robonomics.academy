  ...
  <LayoutCourse courseId="3" lessonId="3">
    ...
    <section class="text__hyphened">
      <section class="container__narrow">
        ...
        <figure class="figure">
          <img src="../../../assets/images/smart-house-course/lesson-3-1.jpg" alt="scheme" />
          <figcaption>{{$ts('In addition, you will complete the Home Assistant setup and add MQTT integration to it.')}}</figcaption>
        </figure>
      </section>
...
password_file /etc/mosquitto/passwd
              ...
              <li>
                ...
                <g-image src="../../../assets/images/smart-house-course/lesson-3-2.jpg" alt="code"></g-image>
              </li>
            </List>
          </li>
          <li>
            ...
            <List>
              <li>
                ...
                <g-image src="../../../assets/images/smart-house-course/lesson-3-3.jpeg" alt="pic"></g-image>
              </li>
              <li>
                ...
                <g-image src="../../../assets/images/smart-house-course/lesson-3-4.jpeg" alt="pic"></g-image>
              </li>
              <li>
                ...
                <g-image src="../../../assets/images/smart-house-course/lesson-3-5.jpeg" alt="pic"></g-image>
              </li>
              <li>
                <p>{{$ts('Now we need to install a MQTT client. Go to')}} <code>Settings</code> -> <code>Devices & Services.</code></p>
                <g-image src="../../../assets/images/smart-house-course/lesson-3-6.jpeg" alt="pic"></g-image>
              </li>
              <li>
                <p>{{$ts('Press')}} <code>ADD INTEGRATION</code> {{$ts('button at the right bottom corner. In the opened window find')}} <code>MQTT</code>:</p>
                <g-image src="../../../assets/images/smart-house-course/lesson-3-7.jpeg" alt="pic"></g-image>
              </li>
              <li>
                ...
                <g-image src="../../../assets/images/smart-house-course/lesson-3-8.jpeg" alt="pic"></g-image>
              </li>
              <li>
                ...
                <g-image src="../../../assets/images/smart-house-course/lesson-3-9.jpeg" alt="pic"></g-image>
              </li>
            </List>
          </li>
        </List>
