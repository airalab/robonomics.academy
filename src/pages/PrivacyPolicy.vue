<template>
  <Layout>
    ...
    <article class="privacy-policy container__narrow">
      <div class="layout layout__content">
        <h1 class="text-center">{{$t('Privacy Policy')}}</h1>
        <span class="privacy-policy__updated"><em>{{ $t('Last updated: February 05, 2025') }}</em></span>
          ...
          <div class="privacy-policy__wrapper">
            ...
            <ul>
              <li>
                <strong>{{$t('DAO')}}</strong> {{ $t('(referred to as either "the DAO", "We", "Us" or "Our" in this Agreement) refers to decentralized autonomous organization Robonomics Network, an operator for website')}} <g-link to="/">robonomics.academy </g-link> {{$t('(referred to as') }} <strong>{{ $t('Website') }}</strong> {{ $t('in this Agreement). For the purpose of the GDPR, the DAO is the Data Controller.')}}
              </li>
        ...
        <div class="privacy-policy__wrapper">
          ...
          <ul>
            <li>{{ $t('By visiting this page on our website:') }} <g-link to="https://robonomics.network/contact/">https://robonomics.network/contact/</g-link></li>
          </ul>
        </div>
      </div>

      <div class="layout layout__content policy-privacy__ai">
