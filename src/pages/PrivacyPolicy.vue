  ...
  <Layout>
    ...
    <section class="privacy-policy container__narrow">
      ...
      <div class="privacy-policy__wrapper">
        ...
        <p class="privacy-policy__descr">{{$ts('In order for us to provide you the best possible experience on our websites, we need to collect and process certain information. Depending on your use of the Services, that may include:')}}</p>
      ...
      <div class="privacy-policy__wrapper">
        ...
        <p class="privacy-police__descr">You can opt out of being tracked by our Matomo Analytics instance below:</p>
      ...
      <div class="privacy-policy__wrapper">
        ...
        <p class="privacy-police__descr">
          We will retain your information as long as necessary to provide you with the services or as otherwise set forth in this Policy. We will also retain and use this information as necessary for the purposes set out in this Policy and to the extent necessary to comply with our legal obligations, resolve disputes, enforce our agreements and protect Robonomics Academy legal rights.
        </p>
        <p class="privacy-police__descr">We also collect and maintain aggregated, anonymized or pseudonymized information which we may retain indefinitely to protect the safety and security of our Site, improve our Services or comply with legal obligations.</p>
      </div>
