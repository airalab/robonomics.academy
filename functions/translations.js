...
module.exports = function (fs, path) {
  ...
  const fullLocales = [
    ...
    fullLocales.map(l => {
      ...
      if(!fs.existsSync(`courses/${l.abbr}/${path}.md`, 'utf-8')) {
        console.log('file not exists')
      } else {
        let data = fs.readFileSync(`courses/${l.abbr}/${path}.md`, 'utf-8');
        const post = JSON.parse(fs.readFileSync(`./translations/lessons/${l.full}.json`));
        ...
        fs.writeFile(`courses/${l.abbr}/${path}.md`, data, 'utf8', function (err) {
